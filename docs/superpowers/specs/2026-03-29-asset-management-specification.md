# 资产管理系统 (Asset Management System) 业务与技术规范说明书

## 1. 项目概况
本项目是一套基于 **RuoYi-Vue** 深度定制开发的资产管理系统。旨在通过规范化的业务单据流转，实现资产从“采购入库”到“日常运维”再到“处置报废”的全生命周期闭环管理。
...
### 2.1 核心业务领域 (Domain)
系统围绕以下核心实体展开：
*   **资产台账 (`AssetInfo`)**：中心数据源，存储资产的基础属性（编号、名称、分类、状态、位置、保管人等）。
