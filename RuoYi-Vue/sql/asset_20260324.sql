...
create table asset_category (
  ...
  serial_required_flag char(1) default 'N' comment '是否必须序列号',
  borrowable_flag char(1) default 'N' comment '是否允许借用',
  inventory_required_flag char(1) default 'Y' comment '是否纳入盘点',
  useful_life_months int(11) default null comment '使用寿命(月)',
...
create table asset_location (
  ...
  parent_id bigint(20) default 0 comment '父位置ID',
  ancestors varchar(500) default '' comment '祖级列表',
  ...
  manager_user_id bigint(20) default null comment '位置管理员ID',
  order_num int(4) default 0 comment '显示顺序',
  status char(1) default '0' comment '状态(0正常 1停用)',
  del_flag char(1) default '0' comment '删除标志(0存在 2删除)',
  create_by varchar(64) default '' comment '创建者',
...
create table asset_info (
  ...
  specification varchar(255) default null comment '规格描述',
  ...
  qr_code varchar(200) default null comment '二维码值',
...
create table asset_operate_order (
  ...
  biz_date datetime comment '业务时间',
  ...
  from_user_id bigint(20) default null comment '来源责任人ID',
  to_user_id bigint(20) default null comment '目标责任人ID',
  ...
  disposal_reason varchar(500) default null comment '报废原因',
