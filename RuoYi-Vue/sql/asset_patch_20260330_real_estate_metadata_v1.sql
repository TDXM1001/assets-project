...
INSERT INTO `asset_category` (`category_code`, `category_name`, `asset_type`, `parent_id`, `ancestors`, `order_num`, `field_template_json`, `status`, `del_flag`, `create_by`, `create_time`)
